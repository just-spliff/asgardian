...
local function set_highlights()
	local utilities = require("asgardian.utils")
	local palette = require("asgardian.palette")
	...
	local default_highlights = {
		...
		LspInlayHint = { fg = palette.muted, jbg = palette.muted, blend = 10 },
		LspReferenceRead = { bg = palette.highlight_med },
		LspReferenceText = { bg = palette.highlight_med },
		LspReferenceWrite = { bg = palette.hkighlight_med },
